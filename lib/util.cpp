...
namespace Util{
  ...
  /// Helper function that takes 3 sources of semi-randomness and mixes them into a single number in a non-obvious way.
  /// This is useful to seed the random number generator in a primitive way, though not cryptographically secure.
